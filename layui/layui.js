...
;!function (d) {
    ...
    var t, h = d.document, m = {modules: {}, status: {}, timeout: 10, event: {}}, o = function () {
        ...
        v = (t = h.currentScript && "SCRIPT" === h.currentScript.tagName.toUpperCase() ? h.currentScript.src : function () {
            for (var t, e = h.getElementsByTagName("script"), n = e.length - 1, o = n; 0 < o; o--) if ("interactive" === e[o].readyState) {
                t = e[o].src;
                break
            }
            return t || e[n].src
            ...
            var r, i, a = this, u = m.dir = m.dir || v, l = h.getElementsByTagName("head")[0],
                ...
                }), layui.jquery = layui.$ = jQuery), n[0]), c = 0;
            ...
            if ("function" == typeof n) if (this.isArray(t = t || [])) for (e = 0; e < t.length && !o(e, t); e++) ; else for (e in t) if (o(e, t)) break;
            return this
        ...
        var a, n, i, l, r = this, o = r.config, d = r.lang(), s = "static" === o.position,
            ...
            p = (o.zIndex && (y.style.zIndex = o.zIndex), lay.each(new Array(2), function (e) {
                ...
                var a = lay.elem("div", {"class": "layui-laydate-header"}),
                    t = [((t = lay.elem("i", {"class": "layui-icon laydate-icon laydate-prev-y"})).innerHTML = "&#xe65a;", t), ((t = lay.elem("i", {"class": "layui-icon laydate-icon laydate-prev-m"})).innerHTML = "&#xe603;", t), ((t = lay.elem("div", {"class": "laydate-set-ym"})).appendChild(lay.elem("span")), t.appendChild(lay.elem("span")), t), ((t = lay.elem("i", {"class": "layui-icon laydate-icon laydate-next-m"})).innerHTML = "&#xe602;", t), ((t = lay.elem("i", {"class": "layui-icon laydate-icon laydate-next-y"})).innerHTML = "&#xe65b;", t)],
...
!function (p, m) {
    ...
    var h, g, e, n = p.layui && layui.define, f = {
            getPath: (e = document.currentScript && "SCRIPT" === document.currentScript.tagName.toUpperCase() ? document.currentScript.src : function () {
                for (var e, t = document.getElementsByTagName("script"), i = t.length - 1, n = i; 0 < n; n--) if ("interactive" === t[n].readyState) {
                    e = t[n].src;
                    break
                }
                return e || t[i].src
...
layui.define(["jquery", "laytpl", "lay", "util"], function (e) {
    ...
    var n, i, t, c = layui.$, m = layui.laytpl, p = layui.util, l = layui.hint(),
        ...
        s = "layui-menu-item-group", C = "layui-menu-item-parent", u = "layui-menu-item-checked",
        V = "layui-menu-item-checked2", x = "layui-menu-body-panel", b = "layui-menu-body-panel-left",
        k = "layui-dropdown-shade", T = "." + s + ">." + w, D = function (e) {
            var i = this;
    ...
    D.prototype.config = {
        ...
        accordion: !1,
        closeOnClick: !1
    }, D.prototype.reload = function (e, i) {
        var t = this;
        t.config = c.extend({}, t.config, e), t.init(!0, i)
    }, D.prototype.init = function (e, i) {
    ...
    }, D.prototype.render = function (e, i) {
        ...
        !(e = "contextmenu" !== d.trigger && !lay.isTopElem(d.elem[0]) ? e : !0) && d.elem.data(y + "_opened") || (a.elemView = c("." + v + "[" + f + '="' + d.id + '"]'), "reloadData" === i && a.elemView.length ? a.elemView.html(d.content || n()) : (a.elemView = c(l), a.elemView.append(d.content || n()), d.className && a.elemView.addClass(d.className), d.style && a.elemView.attr("style", d.style), h.thisId = d.id, a.remove(), t.append(a.elemView), d.elem.data(y + "_opened", !0), e = d.shade ? '<div class="' + k + '" style="z-index:' + (a.elemView.css("z-index") - 1) + "; background-color: " + (d.shade[1] || "#000") + "; opacity: " + (d.shade[0] || d.shade) + '"></div>' : "", a.elemView.before(e), "mouseenter" === d.trigger && a.elemView.on("mouseenter", function () {
            ...
            var i = c(this), t = i.data("item") || {}, n = t[s.children] && 0 < t[s.children].length,
                l = "all" === d.clickScope;
            t.disabled || n && !l || "-" === t.type || (!1 === ("function" == typeof d.click ? d.click(t, i, e) : null) || n || a.remove(), layui.stope(e))
    ...
    }, D.prototype.position = function (e) {
        var i = this.config;
        ...
        var i = this, t = i.config,
            n = ("hover" === t.trigger && (t.trigger = "mouseenter"), i.prevElem && i.prevElem.off(t.trigger, i.prevElemCallback), "mouseenter" === t.trigger);
        i.prevElem = t.elem, i.prevElemCallback = function (e) {
            clearTimeout(g.timer), i.e = e, n ? g.timer = setTimeout(function () {
                i.render()
            }, i.normalizedDelay().show) : t.closeOnClick && t.elem.data(y + "_opened") && "click" === t.trigger ? i.remove() : i.render(), e.preventDefault()
        }, t.elem.on(t.trigger, i.prevElemCallback), n && t.elem.on("mouseleave", function () {
            i.delayRemove()
        })
        ...
        if (h.thisId) {
            ...
            if (i) {
                var t = i.config, n = lay.isTopElem(t.elem[0]), l = "contextmenu" === t.trigger,
                    n = !(n || l) && (t.elem[0] === e.target || t.elem.find(e.target)[0]),
                    l = i.elemView && (e.target === i.elemView[0] || i.elemView.find(e.target)[0]);
                if (!n && !l) {
                    if ("touchstart" === e.type && t.elem.data(y + "_opened") && c(e.target).hasClass(k) && e.preventDefault(), "function" == typeof t.onClickOutside) if (!1 === t.onClickOutside(e)) return;
                    i.remove()
                }
            }
        }
    }, {passive: !1}), t = ".layui-menu:not(.layui-dropdown-menu) li", i.on("click", t, function (e) {
        var i = c(this), t = i.parents(".layui-menu").eq(0), n = i.hasClass(s) || i.hasClass(C),
            l = t.attr("lay-filter") || t.attr("id"), a = lay.options(this);
        i.hasClass("layui-menu-item-divider") || n || (t.find("." + u).removeClass(u), t.find("." + V).removeClass(V), i.addClass(u), i.parents("." + C).addClass(V), a.title = a.title || c.trim(i.children("." + w).text()), layui.event.call(this, r, "click(" + l + ")", a))
    ...
    }), t = ".layui-menu ." + C, i.on("mouseenter", t, function (e) {
...
layui.define("jquery", function (t) {
    "use strict";
    var u = layui.$, d = (layui.hint(), layui.device()), r = "element", y = "layui-this", f = "layui-show",
        ...
        g = "layui-nav-more", C = "layui-anim layui-anim-upbit", w = {
            tabClick: function (t) {
                ...
                !1 !== layui.event.call(i[0], r, "tabBeforeDelete(" + n + ")", {
                    ...
                    index: a,
                    id: s
                }) && (i.hasClass(y) && (i.next()[0] && i.next().is("li") ? w.tabClick.call(i.next()[0], {index: a + 1}) : i.prev()[0] && i.prev().is("li") && w.tabClick.call(i.prev()[0], null, a - 1)), i.remove(), (s ? i = (i = l.filter('[lay-id="' + s + '"]')).length ? i : l.eq(a) : l.eq(a)).remove(), setTimeout(function () {
                    w.tabAuto()
                ...
                var t = u(this), i = t.closest(h), a = i.attr("lay-filter"), e = t.parent(), l = t.siblings("." + m),
                ...
                tab: function (t) {
                    ...
                    (t || u(h + a)).each(function (t) {
                        var i = u(this), a = u('<span class="' + b + '"></span>'), e = i.find("." + p),
                            l = i.find("." + b)[0];
                        l && l.remove(), i.append(a), (i.hasClass(v) ? e.find("dd,>." + r) : e).off("mouseenter.lay_nav").on("mouseenter.lay_nav", function () {
                            !function (t, i, a) {
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function (c) {
    "use strict";
    var f = layui.$, s = layui.lay, m = layui.laytpl, z = layui.laypage, p = layui.layer, i = layui.form,
        g = layui.util, v = layui.hint(), b = layui.device(), x = {
            config: {
            ...
            var t = k.that[e];
            return t || v.error(e ? "The table instance with ID '" + e + "' not found" : "ID argument required"), t || null
        }, l = function (e) {
            var t = k.config[e];
            return t || v.error(e ? "The table instance with ID '" + e + "' not found" : "ID argument required"), t || null
        }, C = function (e) {
            ...
            }(t) || String(i)).render(f.extend({LAY_COL: a}, e.tplData))), e.text ? f("<div>" + i + "</div>").text() : i
        }, T = "table", R = "lay-" + T + "-id", t = ".layui-table", N = "layui-hide", y = "layui-hide-v", h = "layui-none",
        W = "layui-table-view", o = ".layui-table-header", D = ".layui-table-body", P = ".layui-table-fixed-r",
        O = ".layui-table-pageview", L = ".layui-table-sort", E = "layui-table-checked", A = "layui-table-edit",
        F = "layui-table-hover", u = "laytable-cell-group", M = "layui-table-col-special", _ = "layui-table-tool-panel",
        S = "layui-table-expanded", I = "layui-table-disabled-transition", H = "LAY_TABLE_MOVE_DICT", e = function (e) {
        ...
        d = f(window), j = f(document), n = function (e) {
            this.index = ++x.index, this.config = f.extend({}, this.config, x.config, e), this.render()
        }, r = (n.prototype.config = {
            limit: 10,
            loading: !0,
            escape: !0,
            cellMinWidth: 60,
            ...
            if (k.that[i] = t, (k.config[i] = a).request = f.extend({
                pageName: "page",
                limitName: "limit"
            ...
            var l, e = a.elem, i = e.next("." + W), n = t.elem = f("<div></div>");
            n.addClass((l = [W, W + "-" + t.index, "layui-form", "layui-border-box"], a.className && l.push(a.className), l.join(" "))).attr(((l = {
                "lay-filter": "LAY-TABLE-FORM-DF-" + t.index,
                style: (l = [], a.width && l.push("width:" + a.width + "px;"), l.join(""))
            })[R] = a.id, l)).html(m(B, {open: "{{", close: "}}"}).render({
                data: a,
                index: t.index
            })), t.renderStyle(), i[0] && i.remove(), e.after(n), t.layTool = n.find(".layui-table-tool"), t.layBox = n.find(".layui-table-box"), t.layHeader = n.find(o), t.layMain = n.find(".layui-table-main"), t.layBody = n.find(D), t.layFixed = n.find(".layui-table-fixed"), t.layFixLeft = n.find(".layui-table-fixed-l"), t.layFixRight = n.find(P), t.layTotal = n.find(".layui-table-total"), t.layPage = n.find(".layui-table-page"), t.renderToolbar(), t.renderPagebar(), t.fullSize(), t.setColsWidth(), t.pullData(t.page), t.events()
            ...
            if (r.clientWidth = r.width || (l = function (e) {
                var t, a;
                e = e || r.elem.parent(), a = window.getComputedStyle ? "border-box" !== (a = d.getElementSize(e[0])).boxSizing || s.ie ? a.width : a.width - a.paddingLeft - a.paddingRight - a.borderLeftWidth - a.borderRightWidth : e.width();
                try {
                    t = "none" === e.css("display")
                } catch (i) {
                }
                return !e[0] || s.isTopElem(e[0]) || a && !t ? a : l(e.parent())
            })(), "width" === e) return r.clientWidth;
            r.height = r.maxHeight || r.height, r.css && -1 === r.css.indexOf(W) && (a = r.css.split("}"), layui.each(a, function (e, t) {
                t && (a[e] = "." + W + "-" + d.index + " " + t)
            }), r.css = a.join("}"));
            ...
            layui.each(l.cols, function (a, e) {
                ...
                t && o.push(a + " " + t)
            })), l.css && o.push(l.css), s.style({target: this.elem[0], text: o.join(""), id: "DF-table-" + n})
                ...
                n = ("default" === e.toolbar ? a.html(t) : "string" == typeof e.toolbar && (t = f(e.toolbar).html() || "") && a.html(m(t).render(e)), {
                            ...
                            (0, e.openPanel)({
                                list: (a = [], o.eachCols(function (e, t) {
                                    ...
                                    i.on("checkbox(LAY_TABLE_TOOL_COLS)", function (e) {
                                        var e = f(e.elem), t = this.checked, a = e.data("key"), i = o.col(a), l = i.hide,
                                            e = e.data("parentkey");
                                        i.key && (i.hide = !t, o.elem.find('*[data-key="' + a + '"]')[t ? "removeClass" : "addClass"](N), l != i.hide && o.setParentCol(!t, e), o.resize(), layui.event.call(this, T, "colToggled(" + d + ")", {
                                            col: i,
                                            config: n
                                        }))
                                    })
                    ...
                    exports: {
                        ...
                        onClick: function (e) {
                            ...
                            if (!t.length) return p.tips("\u5f53\u524d\u8868\u683c\u65e0\u6570\u636e", e, {tips: 3});
                            b.ie ? p.tips("\u5bfc\u51fa\u529f\u80fd\u4e0d\u652f\u6301 IE\uff0c\u8bf7\u7528 Chrome \u7b49\u9ad8\u7ea7\u6d4f\u89c8\u5668\u5bfc\u51fa", e, {tips: 3}) : i({
                    ...
                    print: {
                        title: "\u6253\u5370", layEvent: "LAYTABLE_PRINT", icon: "layui-icon-print", onClick: function (e) {
                            ...
                            a.append(o.layMain.find("table").html()), a.append(o.layTotal.find("table").html()), a.find("th.layui-table-patch").remove(), a.find("thead>tr>th." + M).filter(function (e, t) {
                                return !f(t).children("." + u).length
                            }).remove(), a.find("tbody>tr>td." + M).remove(), t.document.write(e + a.prop("outerHTML")), t.document.close(), layui.device("edg").edg ? (t.onafterprint = t.close, t.print()) : (t.print(), t.close())
                        }
                    }
                });
            ...
            l.config.cols.length <= 1 || ((e = l.layHeader.find((i ? "th[data-key=" + i.data("parentkey") + "]>" : "") + "." + u)).css("width", 0), layui.each(e.get().reverse(), function () {
                ...
                l.layHeader.eq(0).find("th[data-parentkey=" + t + "]").width(function (e, t) {
                    f(this).hasClass(N) || 0 < t && (a += t)
                }), a && e.css("max-width", a - 1), i && e.parent().data("parentkey") && l.setGroupWidth(e.parent())
            }), e.css("width", "auto"))
        }, n.prototype.setColsWidth = function () {
            var n, o = this, d = o.config, a = 0, r = 0, c = 0, s = 0, u = o.setInit("width"),
                i = parseFloat(layui.getStyle(o.elem[0], "border-left-width")), e = (o.eachCols(function (e, t) {
                ...
                y = (e(), e(!0), o.autoColNums = r = 0 < r ? r : 0, o.layMain.find("tbody").is(":empty") ? (e = o.layHeader.first().children("table").width(), o.layMain.find("table").width(e)) : o.layMain.find("table").width("auto"), u);
            o.eachCols(function (e, a) {
                ...
                a.colGroup || a.hide || n && n.key === a.key || (0 === a.width ? o.cssRules(a.key, function (e) {
                    ...
                    e.style.width = t + "px", y -= t
                }) : /\d+%$/.test(a.width) ? o.cssRules(a.key, function (e) {
                    var t = Math.round(parseFloat(a.width) / 100 * u);
                    e.style.width = (t = l < (t = t < i ? i : t) ? l : t) + "px", y -= t
                }) : o.cssRules(a.key, function (e) {
                    e.style.width = a.width + "px", y -= a.width
                }))
            }), n && o.cssRules(n.key, function (e) {
                var t = n.minWidth || d.cellMinWidth, a = n.maxWidth || d.cellMaxWidth, a = Math.max(Math.min(y, a), t);
                e.style.width = a + "px", o.layMain.prop("offsetHeight") > o.layMain.prop("clientHeight") && (e.style.width = parseFloat(e.style.width) - i + "px")
            }), o.setGroupWidth()
            ...
            a[0] && (t.layNone.remove(), a.remove()), t.layFixed.addClass(N), t.layMain.find("tbody").html(""), t.layMain.append(t.layNone = e), t.layTotal.addClass(y), t.layPage.find(O).addClass(y), x.cache[t.key] = [], t.syncCheckAll(), t.renderForm(), t.setColsWidth(), t.loading(!1)
        }, n.prototype.page = 1, n.prototype.pullData = function (i, l) {
            var e, t, n = this, o = n.config,
                a = (o.HAS_SET_COLS_PATCH || n.setColsPatch(), o.HAS_SET_COLS_PATCH = !0, o.request), d = o.response,
                r = function () {
            ...
            l = l || {}, "function" == typeof o.before && o.before(o), n.startTime = (new Date).getTime(), l.renderData ? ((e = {})[d.dataName] = x.cache[n.key], e[d.countName] = o.url ? "object" === layui.type(o.page) ? o.page.count : e[d.dataName].length : o.data.length, "object" == typeof o.totalRow && (e[d.totalRowName] = f.extend({}, n.totalRow)), n.renderData({
                res: e,
                curr: i,
                count: e[d.countName],
                type: l.type,
            ...
            return n = n || 1, layui.each(a, function (e, o) {
                ...
                "array" === layui.type(o) && 0 === o.length || (o[x.config.numbersName] = c, l || (o[x.config.indexName] = e), s.eachCols(function (e, l) {
                    ...
                    n !== undefined && null !== n || (n = ""), l.colGroup || (e = ['<td data-field="' + e + '" data-key="' + a + '" ' + (e = [], (t = "function" == typeof l.edit ? l.edit(o) : l.edit) && e.push('data-edit="' + t + '"'), l.templet && e.push('data-content="' + g.escape(n) + '"'), l.toolbar && e.push('data-off="true"'), l.event && e.push('lay-event="' + l.event + '"'), l.minWidth && e.push('data-minwidth="' + l.minWidth + '"'), l.maxWidth && e.push('data-maxwidth="' + l.maxWidth + '"'), l.style && e.push('style="' + l.style + '"'), e.join(" ")) + ' class="' + (t = [], l.hide && t.push(N), l.field || t.push(M), t.join(" ")) + '">', '<div class="layui-table-cell laytable-cell-' + ("normal" === l.type ? a : a + " laytable-cell-" + l.type) + '"' + (l.align ? ' align="' + l.align + '"' : "") + ">" + function () {
                        var e, t = f.extend(!0, {LAY_COL: l}, o), a = x.config.checkName, i = x.config.disabledName;
                        switch (l.type) {
                            case"checkbox":
                        ...
                        return l.toolbar ? m(f(l.toolbar).html() || "").render(t) : C.call(s, {
                            item3: l,
                            content: n,
                            tplData: t
                        })
                    }(), "</div></td>"].join(""), i.push(e), l.fixed && "right" !== l.fixed && d.push(e), "right" === l.fixed && r.push(e))
                }), e = ['data-index="' + e + '"'], o[x.config.checkName] && e.push('class="' + E + '"'), e = e.join(" "), y.push("<tr " + e + ">" + i.join("") + "</tr>"), h.push("<tr " + e + ">" + d.join("") + "</tr>"), p.push("<tr " + e + ">" + r.join("") + "</tr>"))
            ...
            return x.cache[a.key] = d, a.layTotal[0 == d.length ? "addClass" : "removeClass"](y), a.layPage[i.page || i.pagebar ? "removeClass" : "addClass"](N), a.layPage.find(O)[!i.page || 0 == n || 0 === d.length && 1 == l ? "addClass" : "removeClass"](y), 0 === d.length ? a.errorView(i.text.none) : (a.layFixLeft.removeClass(N), o ? u() : (u(), a.renderTotal(d, t), a.layTotal && a.layTotal.removeClass(N), void (i.page && (i.page = f.extend({
            ...
            y && (r.layBox.addClass(I), "radio" === i.type) || (u && (a = {}, layui.each(i.index, function (e, t) {
                ...
                return i.index[e]
            } : '[data-index="' + i.index + '"]'), i = f.extend({type: "checkbox"}, i), l = x.cache[r.key], t = "checked" in i, n = function (e) {
                return "radio" === i.type || (t ? i.checked : !e)
            }, e.each(function () {
                var e = f(this), t = e.attr("data-index"), a = l[t];
                t && "array" !== layui.type(a) && !a[c.disabledName] && (a = a[c.checkName] = n(e.hasClass(E)), e.toggleClass(E, !!a), "radio" === i.type) && (o = t, e.siblings().removeClass(E))
            ...
            }[i.type] || "checkbox") + '"]:not(:disabled)')).last()).closest(P), ("radio" === i.type && d.hasClass(N) ? s.first() : s).prop("checked", n(u.prop("checked"))), r.syncCheckAll(), y && setTimeout(function () {
            ...
            try {
                ...
                t.layHeader.find("th").find(L).removeAttr("lay-sort"), c.attr("lay-sort", l.type || null), t.layFixed.find("th")
            } catch (s) {
                v.error("Table modules: sort field '" + d + "' not matched")
            }
            t.sortKey = {
                field: d,
                sort: l.type
                ...
                field: d,
                type: l.type
            }, layui.event.call(l.field, T, "sort(" + n + ")", f.extend({config: i}, i.initSort)))
        }, n.prototype.loading = function (e) {
            this.config.loading && this.layBox.find(".layui-table-init").toggleClass(N, !e)
            ...
            var c = this, s = c.config, o = s.elem.attr("lay-filter"), e = c.layHeader.find("th"), u = ".layui-table-cell",
                d = f("body"), r = {}, y = (c.layTool.on("click", "*[lay-event]", function (e) {
                    var i = f(this), a = i.attr("lay-event"), l = x.cache[s.id], n = function (e) {
                        var t = f(e.list), a = f('<ul class="' + _ + '"></ul>');
                        a.html(t), s.height && a.css("max-height", s.height - (c.layTool.outerHeight() || 50)), i.find("." + _)[0] || i.append(a), c.renderForm(), a.on("click", function (e) {
                            layui.stope(e)
                        }), e.done && e.done(a, t)
                    };
                    layui.stope(e), j.trigger("table.tool.panel.remove"), p.close(c.tipsIndex), layui.each(s.defaultToolbar, function (e, t) {
                    ...
                    }), layui.event.call(this, T, "toolbar(" + o + ")", f.extend({event: a, config: s}, {}))
                }), c.layHeader.on("click", "*[lay-event]", function (e) {
                    var t = f(this), a = t.attr("lay-event"), t = t.closest("th").data("key"), t = c.col(t);
                    layui.event.call(this, T, "colTool(" + o + ")", f.extend({event: a, config: s, col: t}, {}))
                }), c.layPagebar.on("click", "*[lay-event]", function (e) {
                    var t = f(this).attr("lay-event");
                    layui.event.call(this, T, "pagebar(" + o + ")", f.extend({event: t, config: s}, {}))
                    ...
                    }), a.data(H, r), k.eventMoveElem = a)
                }), k.docEvent || j.on("mousemove", function (e) {
                    var t, a;
                    k.eventMoveElem && (t = k.eventMoveElem.data(H) || {}, k.eventMoveElem.data("resizing", 1), e.preventDefault(), t.rule) && (e = t.ruleWidth + e.clientX - t.offset[0], a = k.eventMoveElem.closest("." + W).attr(R), a = w(a)) && ((e = e < t.minWidth ? t.minWidth : e) > t.maxWidth && (e = t.maxWidth), t.rule.style.width = e + "px", a.setGroupWidth(k.eventMoveElem), p.close(c.tipsIndex))
                }).on("mouseup", function (e) {
                    var t, a, i, l, n;
                    k.eventMoveElem && (i = (t = k.eventMoveElem).closest("." + W).attr(R), a = w(i)) && (i = t.data("key"), l = a.col(i), n = a.config.elem.attr("lay-filter"), r = {}, d.css("cursor", ""), a.scrollPatch(), t.removeData(H), delete k.eventMoveElem, a.cssRules(i, function (e) {
                    ...
                    var t = f(this), a = t.find(L), i = a.attr("lay-sort");
                    ...
                    var a = f(this).parents("tr").eq(0).data("index"), t = c.layBody.find('tr[data-index="' + a + '"]'),
                        i = (x.cache[c.key] || [])[a] || {}, l = {
                    ...
                    e.data("off") || c.layBody.find("tr:eq(" + t + ")").addClass(F)
                }).on("mouseleave", "tr", function () {
                    var e = f(this), t = e.index();
                    e.data("off") || c.layBody.find("tr:eq(" + t + ")").removeClass(F)
                    ...
                    var t = f(this), a = t.children(u);
                    t.data("off") || t.parent().hasClass(S) || (e ? t.find(".layui-table-grid-down").remove() : !(a.prop("scrollWidth") > a.prop("clientWidth") || 0 < a.find("br").length) || s.lineStyle || a.find("." + i)[0] || t.append('<div class="' + i + '"><i class="layui-icon layui-icon-down"></i></div>'))
                }, l = function (e, t) {
                    var a = f(this), i = a.parent(), l = i.data("key"), n = c.col(l), o = i.parent().data("index"),
                        d = i.children(u), i = "layui-table-cell-c", r = f('<i class="layui-icon layui-icon-up ' + i + '">');
                    ...
                    }), c.setRowActive(o, S), d.next("." + i)[0] || d.after(r), r.on("click", function () {
                        var t = f(this);
                        c.setRowActive(o, [S, F].join(" "), !0), c.cssRules(l, function (e) {
            ...
            c.layBody.on("click", "*[lay-event]", function (e) {
                ...
                c.layHeader.scrollLeft(t), c.layTotal.scrollLeft(t), c.layFixed.find(D).scrollTop(e), p.close(c.tipsIndex)
            ...
            return e.each(function () {
                var l, e = f(this), t = e.attr("lay-data"),
                    t = s.options(this, {attr: t ? "lay-data" : null, errorText: d + (t || e.attr("lay-options"))}),
                    n = f.extend({
                        elem: this,
                        cols: [],
                        data: [],
                        ...
                        n.cols[i] = [], f(this).children().each(function (e) {
                            var t = f(this), a = t.attr("lay-data"),
                                a = s.options(this, {attr: a ? "lay-data" : null, errorText: d + (a || t.attr("lay-options"))}),
                                t = f.extend({
                                    title: t.text(),
            ...
            l.colGroup && (n = 0, a++, l.CHILD_COLS = [], o = e + (parseInt(l.rowspan) || 1), layui.each(i[o], function (e, t) {
                t.parentKey ? t.parentKey === l.key && (t.PARENT_COL_INDEX = a, l.CHILD_COLS.push(t), r(a, i, o, t)) : t.PARENT_COL_INDEX || 1 <= n && n == (l.colspan || 1) || (t.PARENT_COL_INDEX = a, l.CHILD_COLS.push(t), n += parseInt(1 < t.colspan ? t.colspan : 1), r(a, i, o, t))
            }))
        });
    x.eachCols = function (e, a, i) {
        var e = k.config[e] || {}, l = [], n = (i = f.extend(!0, [], i || e.cols), layui.each(i, function (a, e) {
            if (a) return !0;
            layui.each(e, function (e, t) {
        ...
        var a = 0, i = [], l = [], e = x.cache[e] || [];
        return layui.each(e, function (e, t) {
            "array" === layui.type(t) || t[x.config.disabledName] ? a++ : t[x.config.checkName] && (i.push(x.clearCacheKey(t)), l.push(t))
        ...
        if (b.ie) return v.error("IE_NOT_SUPPORT_EXPORTS");
        var r, c, s, u, y = l.tree && l.tree.view;
        if (y) try {
            t = f.extend(!0, [], x.cache[e]), t = function h(e) {
        ...
        d.href = "data:" + n + ";charset=utf-8,\ufeff" + encodeURIComponent((r = [], c = [], s = [], u = {}, layui.each(t, function (i, l) {
            ...
            "object" == typeof e ? (layui.each(e, function (e, t) {
                0 == i && r.push(t || "")
            }), layui.each(layui.isArray(l) ? f.extend([], l) : x.clearCacheKey(l), function (e, t) {
                n.push('"' + (t || "") + '"')
        ...
        return delete (e = f.extend({}, e))[x.config.checkName], delete e[x.config.indexName], delete e[x.config.numbersName], delete e[x.config.disabledName], e
    }, f(function () {
        x.init()
    }), c(T, x)
});
...
layui.define("jquery", function (o) {
    ...
    l.prototype.load = function (o) {
        var i, n, r, l, c, m, e, t, a, f, s, u, p, d, y, g = this, h = 0, v = w((o = o || {}).elem);
